...
import com.example.cinema_ticket_system.email.EmailSender;
import com.example.cinema_ticket_system.email.EmailValidator;
...
public class RegistrationService {
    ...
    public String  registerUser(RegistrationRequest registrationRequest) {
        ...
        emailSender.send(
                registrationRequest.email(),
                buildEmail(registrationRequest.firstname(), link));
    ...
    public String verifyEmail(String token) {
        ...
        userService.unlock(confirmationToken.getUser().getEmail());
